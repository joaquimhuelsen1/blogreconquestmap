...
translations = {
    'en': {
        ...
        'test': 'Reconquest Test',
        'ai_chat': 'Relationship AI',
        'premium': 'Premium',
        'admin': 'Admin',
        ...
        # Homepage
        'welcome': 'Welcome to Reconquest Blog',
        'specialized_content': 'Specialized content on male reconquest and relationships.',
        'learn_strategies': 'Learn the best strategies to improve your relationships and win the woman of your dreams.',
        'register_button': 'Register',
        'free_version_notice': 'You are accessing our free version. To access exclusive content, become a premium user!',
        'test_banner_title': 'Let\'s Find Out What Kind Of Chance You Have With Your Ex',
        'test_banner_description': 'My name is Ethan Heyes and I\'m a specialist in helping couples reunite after breakups. Take my test to find out where you stand.',
        ...
        'get_access': 'Get access to exclusive content about:',
        'advanced_psychology': 'Advanced female psychology',
        'reconquest_strategies': 'Reconquest strategies',
        'exclusive_tips': 'Exclusive relationship tips',
        ...
        # Footer
        'best_content': 'The best content on male reconquest and relationships.',
        'quality_content': 'Exclusive articles about relationships and personal development.',
        'all_rights_reserved': 'All rights reserved.',
        
        # Posts
        'premium_required': 'This content is exclusive for premium users.',
        'comments': 'Comments',
        'leave_comment': 'Leave a comment',
        'submit': 'Submit',
        'login_to_comment': 'You need to log in to comment.',
    ...
    'pt': {
        ...
        'free_posts': 'Posts Gratuitos',
        'premium_posts': 'Posts Premium',
        'test': 'Teste de Reconquista',
        'ai_chat': 'IA de Relacionamento',
        'premium': 'Premium',
        'admin': 'Admin',
        ...
        # Página inicial
        'welcome': 'Bem-vindo ao Reconquest Blog',
        'specialized_content': 'Conteúdo especializado em reconquista masculina e relacionamentos.',
        'learn_strategies': 'Aprenda as melhores estratégias para melhorar seus relacionamentos e conquistar a mulher dos seus sonhos.',
        'register_button': 'Cadastre-se',
        'free_version_notice': 'Você está acessando nossa versão gratuita. Para acessar conteúdo exclusivo, torne-se um usuário premium!',
        'test_banner_title': 'Vamos Descobrir Que Chance Você Tem Com Sua Ex',
        'test_banner_description': 'Meu nome é Ethan Heyes e sou especialista em ajudar casais a se reunirem após términos. Faça meu teste para descobrir onde você está.',
        'take_test': 'Faça seu teste',
        ...
        'read_more': 'Leia mais',
        'no_articles': 'Nenhum artigo publicado ainda.',
        'subscribe_premium': 'Assine o Premium',
        'get_access': 'Tenha acesso a conteúdo exclusivo sobre:',
        'advanced_psychology': 'Psicologia feminina avançada',
        'reconquest_strategies': 'Estratégias de reconquista',
        'exclusive_tips': 'Dicas exclusivas de relacionamento',
        'personalized_support': 'Suporte personalizado',
        'learn_more': 'Saiba mais',
        'previous': 'Anterior',
        'next': 'Próximo',
        
        # Rodapé
        'best_content': 'O melhor conteúdo sobre reconquista masculina e relacionamentos.',
        'quality_content': 'Artigos exclusivos sobre relacionamentos e desenvolvimento pessoal.',
        'all_rights_reserved': 'Todos os direitos reservados.',
        
        # Posts
        'premium_required': 'Este conteúdo é exclusivo para usuários premium.',
        'comments': 'Comentários',
        'leave_comment': 'Deixe um comentário',
        'submit': 'Enviar',
        'login_to_comment': 'Você precisa fazer login para comentar.',
        'comment_submitted': 'Seu comentário foi enviado.',
        'comment_published': 'Seu comentário foi publicado.',
...
def get_locale():
    """Determina o idioma atual com base na sessão ou no padrão"""
    if 'lang' not in session:
        session['lang'] = 'pt'  # Idioma padrão é português
    return session['lang']
...
def translate(key):
    ...
    # Retorna a própria chave se não encontrar nenhuma tradução
    return key
...
def create_app():
    ...
    # Adicionar rota para alternar idioma
    ...
    # Adicionar context processor para disponibilizar funções de tradução nos templates
    @app.context_processor
